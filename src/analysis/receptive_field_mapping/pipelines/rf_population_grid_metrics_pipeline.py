...
def _compute_baseline_metrics(
    ...
    return compute_grid_cell_metrics(rf_map, forearm_vertices, projection_method, rotation_matrix=rotation_matrix, slim_cache_path=slim_cache_path)
...
def run_population_rf_grid_metrics(
    ...
    slim_uv_cache_dir: 'Path | None' = None,
) -> list:
    produced = []
