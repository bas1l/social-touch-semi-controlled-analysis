...
<!-- The repo owner's commit fbea05d (rf-depth-weighting) also sits on this
     branch but is not this plan's work, so its files are excluded. -->
...
- configs/analyse_workflow_viewers_dag.layout.json
- configs/analyse_workflow_viewers_dag.yaml
- configs/analysis_task_registry.yaml
- docs/development/plans/active/gui-dag-observability-and-bypass.md
- scripts/analysis_workflow_processing.py
- scripts/analysis_workflow_viewers.py
- src/analysis/pipeline/__init__.py
- src/analysis/pipeline/dag_execution.py
- src/analysis/pipeline/dag_plan.py
- src/analysis/pipeline/execution_events.py
- src/analysis/pipeline/stage_runner.py
- src/analysis/pipeline/task_registry.py
- src/utils/gui/analysis_runner_gui/dag_graph_items.py
- src/utils/gui/analysis_runner_gui/dag_graph_view.py
- src/utils/gui/analysis_runner_gui/process_tree.py
- src/utils/gui/analysis_runner_gui/runner_window.py
- src/utils/gui/analysis_runner_gui/status_channel.py
- src/utils/gui/analysis_runner_gui/task_detail_panel.py
- src/utils/gui/analysis_runner_gui/task_panel.py
- src/utils/pipeline/dag_config_model.py
- tests/test_dag_config_model_bypass.py
- tests/test_dag_execution.py
- tests/test_dag_plan.py
- tests/test_dag_status_overlay.py
- tests/test_execution_core_qt_free.py
- tests/test_execution_events.py
- tests/test_process_tree.py
- tests/test_rf_boundary_dag_wiring.py
- tests/test_stage_runner_adapter.py
- tests/test_status_channel.py
- tests/test_task_panel_contract.py
- tests/test_task_registry.py
